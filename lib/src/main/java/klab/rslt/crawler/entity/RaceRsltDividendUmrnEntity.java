...
/**
 * RACE_RSLT_DIVIDEND_UMRN テーブルの Entity クラスです。
 * 
 * @author ibaragi
 */
@Value
public class RaceRsltDividendUmrnEntity {

	/** クラスパス上の SQL ファイルパス */
	private static final String INSERT_SQL_PATH = "sql/insert_race_rslt_dividend_umrn.sql";
